...
tf/destroy:
	terraform -chdir=infrastructure destroy -var-file=environments/$(ENV)/variables.tfvars -auto-approve
...
tf/plan:
	terraform -chdir=infrastructure plan -var-file=environments/$(ENV)/variables.tfvars -out=tfplan
